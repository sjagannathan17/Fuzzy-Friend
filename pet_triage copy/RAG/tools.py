...
RED_FLAG_SYMPTOMS = {
    ...
    "urgent": {
        ...
        "severity": "URGENT",
        "action": "URGENT - Contact your veterinarian immediately or visit an emergency clinic."
    },
    "moderate": {
...
def triage_and_recommend(
    ...
    """
    Complete triage: check symptoms and recommend nearby vets if CRITICAL.
    
    This function combines check_red_flags and find_nearby_vets for a
    complete emergency triage workflow.
    
    IMPORTANT: find_nearby_vets is ONLY called when severity is CRITICAL
    ...
    # Step 2: ONLY search for nearby vets if severity is CRITICAL
    # CRITICAL = life-threatening, needs IMMEDIATE hospital visit
    ...
    elif red_flag_result["severity"] == "URGENT":
        result["message"] = (
            "This situation requires veterinary attention soon. "
            "Please contact your regular veterinarian or an urgent care clinic today."
        )
